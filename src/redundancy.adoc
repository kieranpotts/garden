...
Redundancy is an important *link:./quality-attribute.adoc[quality attribute]* in distributed software that requires high *link:./availability.adoc[availability]* and *link:./fault-tolerance.adoc[resilience]*. Examples of systems that have high levels of redundancy include data centres and the cloud services that are served from them.
