...
Asynchronous processing may be implemented within a *link:./monolith.adoc[monolith]*
...
*link:./distributed-system.adoc[distributed systems]* to improve performance and scalability.
