...
Asynchronous processing is the foundation of *link:./reactive-programming.adoc[reactive programming]* and *link:./message-driven-architecture.adoc[message-driven architecture]*, and is widely used in *link:./distributed-system.adoc[distributed systems]* to improve performance and scalability.
