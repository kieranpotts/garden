...
Container orchestration, also known as *container management*, refers to the automated management of *link:./containerization.adoc[containerized]* applications. Container orchestration systems manage the life cycle of *link:./container.adoc[containers]*, from deployment to destruction.
