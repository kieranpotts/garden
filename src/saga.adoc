...
In distributed systems, a saga is a design pattern used to manage long-running, multi-step *link:./distributed-transaction.adoc[distributed transactions]*. It is an alternative approach to *link:./phased-commit.adoc[two-phase or three-phase commit (2PC, 3PC)]* protocols.
