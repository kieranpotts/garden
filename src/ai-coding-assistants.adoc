...
See also *link:./integrated-development-environments.adoc[Integrated development environments]*, many of which now have deep integration with AI coding assistants out-of-the-box.
