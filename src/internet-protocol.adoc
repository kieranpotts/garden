...
The *Internet Protocol (IP)* is the fundamental network-layer protocol of the internet. It defines how data is addressed, packetized, and routed across interconnected networks from a source host to a destination host. IP operates at *Layer 3* of the *link:./osi-model.adoc[OSI model]*.
