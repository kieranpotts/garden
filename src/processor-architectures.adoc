...
x86-64 architecture is also known as x86_64, x86-64, x64, or amd64. This refer to a family of processors based on the Intel 8086 and which are compatible with the 64-bit CPU architecture used in modern Intel and AMD processors.
