...
TOGAF is made up of a number of standards, which are maintained by The Open Group – which also maintains the related *xref:archimate.adoc[ArchiMate]* standard – and at the centre of which is the *Architecture Development Method (ADM), which provides a process lifecycle for creating and managing architectures within an enterprise.
