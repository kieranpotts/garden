...
See also *xref:technical-debt.adoc[technical debt]*, which is a different but related concept. A system that has high technical debt is more likely to suffer from faster rot.
