...
Cohesion is a *xref:design-principles.adoc[design principle]* and a measure of the degree to which the elements inside a module belong together. A module with high cohesion is one that groups together elements that are closely related in the *[business domain]*.
