...
In colloquial terms, it means complex products end up "shaped like" the organizational structure they are designed in, or designed for. The law is applied primarily in the field of xref:software-architecture.adoc[software architecture], though Conway directed it more broadly and its assumptions and conclusions apply to most technical fields.

Conway's law is often cited in discussions about the design of software systems, and methods like *xref:domain-driven-design.adoc[domain-driven design]* are intended to mitigate its effects.
