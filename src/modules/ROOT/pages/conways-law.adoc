...
Conway's law is often cited in discussions about the design of software systems,
and methods like *xref:domain-driven-design.adoc[domain-driven design]* are
intended to mitigate its effects.
