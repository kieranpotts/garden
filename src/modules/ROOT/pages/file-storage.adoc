...
* *Basic metadata*: File systems support only standard metadata (name, size, timestamps, permissions). Unlike *xref:object-storage.adoc[object storage]*, there is little support for custom or application-specific metadata.
