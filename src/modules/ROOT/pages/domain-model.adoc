...
In *xref:domain-driven-design.adoc[domain-driven design]*, a domain model is a key artifact that captures the *xref:domain.adoc[domain]* of a software system, its subdomains, and the relationships between the subdomains.
