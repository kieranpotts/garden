...
*Compliance* refers to a software system's adherence to applicable laws, regulations, industry standards, and internal policies. As a *xref:non-functional-requirements.adoc[non-functional requirement]*, compliance defines not what a system does but the conditions under which it must operate, specifically:
...
Whether a system meets its compliance obligations is verified through *xref:compliance-testing.adoc[compliance testing]*.
