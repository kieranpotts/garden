...
The primary goal of caching is to improve system *[performance]*. Other benefits include higher *xref:availability.adoc[availability]*, and *xref:scalability.adoc[scalability]*.
