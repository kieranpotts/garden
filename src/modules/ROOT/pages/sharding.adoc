...
By distributing data across multiple nodes, sharding *xref:load-balancing.adoc[balances load]* across multiple nodes, reducing *[load]* and *xref:fault-tolerance.adoc[risk]* on any single node. This improves system *xref:performance.adoc[performance]*, *xref:availability.adoc[availability]*, and *xref:scalability.adoc[scalability]*.
