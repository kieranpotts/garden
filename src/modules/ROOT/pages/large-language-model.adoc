...
Agent development frameworks such as LangChain and LlamaIndex Can used to build RAG capabilities into agents, providing the retrieval, chunking, and orchestration plumbing so developers do not have to wire it together from scratch. See *xref:ai-agents.adoc[AI agents]*.
