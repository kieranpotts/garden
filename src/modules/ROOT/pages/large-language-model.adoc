...
Frameworks such as *xref:langchain.adoc[LangChain]* and LlamaIndex are commonly used to build RAG pipelines, providing the retrieval, chunking, and orchestration plumbing so developers do not have to wire it together from scratch.
...
* *xref:langchain.adoc[LangChain]* – Framework for building LLM-powered applications and agents.
