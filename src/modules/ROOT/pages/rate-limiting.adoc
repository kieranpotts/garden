...
Rate limiting is a *xref:system-design.adoc[system design]* strategy that helps
protect services from being overwhelmed by too many requests from a single user
or client.
