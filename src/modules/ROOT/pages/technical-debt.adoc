...
without complete knowledge of the final solution, then you must also
iterate the system's design as you go along, adjusting the solution as
you progressively learn more about the project's requirements and
constraints.
...
So, it is actually okay for there to be a little bit of sub-standard
...
.Related links
****
* https://agilealliance.org/introduction-to-the-technical-debt-concept/[Introduction to the technical debt concept],
  Agile Alliance
****
