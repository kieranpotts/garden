...
A PERT chart is a visual project management tool used to map out and track tasks and timelines. The acronym stands for Project (or Program) Evaluation and Review Technique.

PERT was developed in 1958 by the Special Projects Office of the US Department of Defense as part of the Polaris submarine-launched ballistic missile programme. It built on *xref:critical-path-analysis.adoc[Critical Path Analysis]* techniques to support calculations of the time needed to complete projects through systematic analysis of the tasks involved.
