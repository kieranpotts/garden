...
After pre-training, models are typically fine-tuned on task-specific datasets. See *xref:large-language-model.adoc[large language models]* for more on the training pipeline.
