...
The transformer's *attention mechanism* addresses this directly. It lets the model _weigh_ the importance of different words or phrases within a block of text, concentrating on the parts most relevant to the meaning at hand. The effect is far more context-aware and coherent output, and text that reads as far closer to how humans actually speak and write than any earlier text-generation technology achieved.
