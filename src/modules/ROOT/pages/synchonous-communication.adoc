...
Synchronous communication in distributed software can lead to tight coupling between services, making it difficult to change services independently of each other. However, it is often necessary when low *[latency]* or *[real-time data]* processing is a requirement, or when data *xref:consistency.adoc[consistency]* is a primary *[constraint]*.
