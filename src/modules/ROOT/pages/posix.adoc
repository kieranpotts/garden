...
The Portable Operating System Interface (POSIX) is a family of standards maintained by the IEEE Computer Society that specify APIs for xref:shell.adoc[Unix shells] and utility programs, promoting compatibility between shells and the operating systems that use them.
