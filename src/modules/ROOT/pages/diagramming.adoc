...
Our industry's current bias towards *[agile]* software delivery practices has led to a preference for use of lightweight diagramming tools to create visual representations of *[system designs]*, over the production of detailed *xref:modeling.adoc[models]*.
