...
Also known as a *code factory*, a feature factory is a derogatory term for a software development team that focuses on rapidly delivering new features to the detriment of other important attributes, particularly internal qualities like maintainability and extensibility, leading to xref:technical-debt.adoc[technical debt] and a fragile codebase.
