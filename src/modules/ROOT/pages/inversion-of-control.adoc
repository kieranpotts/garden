...
Inversion of control (IoC) is a *xref:design-principles.adoc[design principle]* in which the control flow of a program is somehow inverted.
...
Various *xref:design-patterns.adoc[design patterns]* can be used to implement IoC, such as the *xref:dependency-injection.adoc[dependency injection]* and *[publish-subscribe]* patterns.
