...
Data need not be replicated in the form of its *[source of truth]*. xref:materialized-view.adoc[Materialized views] can be used to store pre-processed data that's optimized for specific use cases, such as reporting.
