...
But in a *xref:distributed-system.adoc[distributed software]*, those joins turn into network calls. This increases *[latency]*, decreasing *xref:performance.adoc[performance]* and having implications for the *xref:fault-tolerance.adoc[resilience]* of the system.
