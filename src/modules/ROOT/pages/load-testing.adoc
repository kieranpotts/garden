...
Together, load testing and volume testing give a comprehensive picture of a system's xref:performance.adoc[performance] at scale, ensuring it can cope with both the breadth of user demand and the depth of data it may be required to handle.
