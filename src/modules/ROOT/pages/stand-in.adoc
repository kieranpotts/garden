...
When Monzo's primary service fails, the Monzo Stand-In service takes over. The stand-in service provides only the most critical services to its customers. The *xref:graceful-degradation.adoc[graceful degradation]* principle applies to the stand-in strategy.
