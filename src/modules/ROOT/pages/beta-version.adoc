...
A beta version is a pre-release of a software product that has more comprehensive functionality than an *xref:alpha-version.adoc[alpha version]* and closely resembles the intended user experience of the final product. 
...
By contrast, an *xref:alpha-version.adoc[alpha version]* is an earlier, less complete prototype with limited functionality, typically tested only by developers or a small internal group.
