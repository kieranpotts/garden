...
At the application level, strong xref:authentication.adoc[authentication] mechanisms – particularly those that do not rely solely on network-level identity signals such as IP addresses – are the primary mitigation.
