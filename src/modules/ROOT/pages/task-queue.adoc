...
Task queues are typically built on top of a *xref:message-queues.adoc[message queue]* system, and can therefore be seen as a higher-level abstraction of message-driven communication that specifically focuses on the processing of computational tasks.
