...
WebRTC does not define a signalling protocol — the application is free to use any transport: *xref:websockets.adoc[WebSockets]*, HTTP polling, or even copy-paste. Signalling carries two types of messages:
