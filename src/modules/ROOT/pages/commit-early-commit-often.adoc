...
This is synonymous with the practice of *xref:continuous-integration.adoc[continuous integration]*, where developers integrate their code into a shared repository multiple times a day.
