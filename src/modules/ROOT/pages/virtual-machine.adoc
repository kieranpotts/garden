...
Virtual machines are created and managed by a *xref:hypervisor.adoc[hypervisor]*, which is a technology layer that abstracts the physical hardware and provides a *virtualized* environment for VMs to run in.
