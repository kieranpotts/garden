...
https://www.his-conference.co.uk/[High-integrity software] is software that is used in safety-critical systems. It is developed to a higher standard than normal software, with an extreme focus on reliability and safety. See also *xref:software-quality.adoc[software quality]* and *xref:software-assurance.adoc[software assurance]*.
