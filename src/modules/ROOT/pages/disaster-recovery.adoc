...
A *xref:stand-in.adoc[Stand-in]* is a disaster recovery strategy devised by Monzo that aims to avoid the scenario of failures cascading through all redundant systems due to software errors.
