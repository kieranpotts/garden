...
The bulkhead xref:design-patterns.adoc[design pattern] is an architectural pattern used to improve the xref:fault-tolerance.adoc[fault tolerance] of *xref:distributed-system.adoc[distributed software]*.
