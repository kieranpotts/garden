...
A counting bloom filter is a variant that replaces each bit with a small counter. Insertion increments the relevant counters, and deletion decrements them. This makes deletion possible, but at a cost:
