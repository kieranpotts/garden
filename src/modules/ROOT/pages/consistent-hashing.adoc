...
Consistent hashing is a special kind of xref:hashing.adoc[hashing] technique that allows for efficient *xref:sharding.adoc[sharding]* of data across a cluster of nodes.
