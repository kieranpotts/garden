...
The factory pattern is recommended in *xref:domain-driven-design.adoc[domain-driven design]* to encapsulate the logic needed to create *[entities]* and *[value objects]*, ensuring that these are created in a consistent and valid state. Factories encapsulate the business rules for creation of business objects, and therefore they exist in the domain layer.
