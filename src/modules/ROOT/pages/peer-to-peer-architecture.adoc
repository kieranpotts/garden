...
P2P networks are known for their *[resilience]* and xref:scalability.adoc[scalability], since there is no central point of failure and the system can scale easily simply by adding new peers to the network.
