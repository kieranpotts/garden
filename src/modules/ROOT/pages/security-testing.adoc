...
Security testing may be conducted using both black-box and white-box approaches, and often involves specialized techniques such as *xref:penetration-testing.adoc[penetration testing]*, vulnerability scanning, and threat modelling.
