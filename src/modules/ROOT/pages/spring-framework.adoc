...
The main goal of the Spring Boot project is to minimize configuration time, enabling developers to more quickly launch prototypes and production-grade applications. Many of the repetitive tasks involved in application setup, such as dependency management and the configuration of embedded servers like https://tomcat.apache.org/[Tomcat] or https://jetty.org/[Jetty], are more automated by Spring Boot.
