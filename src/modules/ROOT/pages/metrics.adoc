...
Metrics tend to be captured in xref:time-series-databases.adoc[time-series databases], with data typically aggregated into time intervals, such as 1-minute, 5-minute, or 1-hour intervals, to reduce the volume of data stored and to make querying more efficient.
