...
How this is done varies between xref:message-queues.adoc[message queues] and xref:stream-processing-systems.adoc[stream processing systems] like Kafka.
