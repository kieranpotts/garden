...
JavaScript's behavior is governed by the *xref:ecmascript.adoc[ECMAScript]* specification. *xref:typescript.adoc[TypeScript]* is a statically typed superset of JavaScript that compiles down to JavaScript.
