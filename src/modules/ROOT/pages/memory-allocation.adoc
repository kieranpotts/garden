...
* *Free list*: A record of all contiguous regions of memory not currently in use, with each entry storing an address and a size.
...
* *CPU cache effects*: How allocation patterns interact with cache lines and hardware prefetching, a concern of *xref:mechanical-sympathy.adoc[mechanical sympathy]*.
