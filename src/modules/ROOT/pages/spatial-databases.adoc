...
Spatial databases are usually implemented in general-purpose database systems, optimized for storage and retrieval of spatial data. Commonly, xref:relational-databases.adoc[relational databases] are used as the underlying technology.
