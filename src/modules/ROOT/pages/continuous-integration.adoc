...
Continuous integration is a prerequisite for *xref:continuous-delivery.adoc[continuous delivery]* and *xref:continuous-deployment.adoc[continuous deployment]*.
