...
The _Mythical Man-Month: Essays on Software Engineering_ is a famous book in the field of software
...
Several concepts and metaphors introduced in _The Mythical Man-Month_ have persisted in popular
...
struggle with the problems, the more you get stuck. No one thing seems to be underlying cause of the
difficulties, but rather a combination of intractable problems make it difficult to move forward.
Some of these factors often could not have been unforeseen.
...
resource. This quadratic growth in communication paths is the cost-side counterpart of
xref:metcalfes-law.adoc[*Metcalfe's law*], which frames the same n² scaling as a source of network
