...
Vibe coding, or vibing, is a *[low-code programming]* *[methodology]* that uses *xref:artificial-intelligence.adoc[artificial intelligence (AI)]* tools to generate code based on natural language *[requirements specifications]*.
