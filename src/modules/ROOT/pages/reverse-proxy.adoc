...
* An *xref:api-gateway.adoc[API gateway]* is a specialised reverse proxy for API management, adding authentication, rate limiting, request/response transformation, aggregation, and API lifecycle management.
