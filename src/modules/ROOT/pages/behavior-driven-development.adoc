...
Behavior-driven development (BDD) is a software development approach devised by Dan North. It is a refinement of *xref:test-driven-development.adoc[test-driven development (TDD)]* that combines TDD techniques with ideas from *xref:domain-driven-design.adoc[domain-driven design]* to create a shared language and process for collaboration between developers, testers, and business stakeholders.
...
BDD suggests that requirements should be expressed as concrete examples of how the system should behave, written in a semi-formal natural language that all team members can read and contribute to. This is the *xref:ubiquitous-language.adoc[ubiquitous language]* concept borrowed from domain-driven design — a shared vocabulary that bridges the gap between technical and non-technical contributors.
...
The Given-When-Then format is formalized as the *xref:gherkin.adoc[Gherkin]* domain-specific language, which is used by many BDD tooling frameworks.
