...
Stepwise refinement is a xref:top-down-design.adoc[top-down] software design technique formalized by Niklaus Wirth in his 1971 paper _Program Development by Stepwise Refinement_, published in _Communications of the ACM_. The approach structures design as a series of progressive refinement steps, moving from a high-level statement of the problem through increasingly concrete levels of detail until the solution can be expressed directly in code.
...
Stepwise refinement is an ancestor of xref:structured-programming.adoc[structured programming] and influenced later design methodologies, including *object-oriented design* and xref:domain-driven-design.adoc[domain-driven design], both of which share its concern with decomposing complexity into manageable, independently reasoned units.
