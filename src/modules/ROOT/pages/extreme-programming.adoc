...
.🧑 Kent Beck
****
Kent Beck is one of the 17 original signatories of the Agile Manifesto, and is a leading proponent of test-driven development. He wrote JUnit with Erich Gamma, and popularized the use of xref:crc-card.adoc[CRC cards] in object-oriented design.
****
