...
A distributed transaction is a type of *xref:transaction.adoc[transaction]* that ensures that all operations across a *[distributed system]*, such as *[microservices]*, are completed successfully, or none at all, maintaining the *[data integrity]* of the overall system.
