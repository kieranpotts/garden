...
* Reduce joins on read operations using *xref:denormalization.adoc[denormalization]*.

* *xref:caching.adoc[Cache]* query results.

* Use *xref:sharding.adoc[partitioning]* to distribute data across multiple storage devices.
