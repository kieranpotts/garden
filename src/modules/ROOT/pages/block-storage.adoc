...
* Higher cost: Block storage is generally more expensive per gigabyte than *xref:object-storage.adoc[object storage]*, making it unsuitable for storing large volumes of infrequently-accessed data.
