...
* *xref:http.adoc[HyperText Transfer Protocol (HTTP)]* — The underlying transport protocol, and the source of REST's uniform interface.
...
* *xref:graphql.adoc[GraphQL]* — A query language for APIs that addresses REST's over-fetching and under-fetching limitations.
