...
ACID refers to a set of properties of database management systems that guarantee that database *xref:transaction.adoc[transactions]* are processed reliably and consistently, ensuring *xref:data-integrity.adoc[data integrity]*.
