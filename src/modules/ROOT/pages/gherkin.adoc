...
Gherkin is a https://martinfowler.com/bliki/BusinessReadableDSL.html[business-readable domain-specific language], which is intended for specifying and documenting *xref:functional-requirements.adoc[functional requirements]*.
