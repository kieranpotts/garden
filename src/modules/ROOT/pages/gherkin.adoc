...
Gherkin is a
https://martinfowler.com/bliki/BusinessReadableDSL.html[business-readable domain-specific language],
...
The Gherkin language was originally developed as part of the https://cucumber.io/[Cucumber] testing
...
See https://kieranpotts.com/standards/001[TS-1: Software Requirements Specification] in my technical
standards.
