...
Related proposals address adjacent problems. Google's A2A (Agent-to-Agent) protocol and the BeeAI/IBM ACP (Agent Communication Protocol) focus on communication *between* agents, rather than between an agent and its tools.
