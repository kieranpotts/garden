...
* Risk of over-engineering. Designing for requirements that may never materialize. Overly complex solutions to simple problems. (See also xref:software-bloat.adoc[software bloat].)
