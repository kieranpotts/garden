...
The agent loop is the core pattern behind an *xref:agent.adoc[AI agent]*. It's the cycle that lets a model take actions in the world rather than just answer once.
