...
In event-driven systems, the events are *business events*, such as "order placed" or "order
shipped". These events are meaningful in the context of the business xref:domain.adoc[*domain*].
