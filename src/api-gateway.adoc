...
* *Authentication and authorization*: Integrates with identity providers (OAuth 2.0, OpenID Connect), validates tokens (e.g. *link:./jwt.adoc[JWT]*), and enforces role-based or scope-based access controls — centralizing security policy enforcement across all services.
