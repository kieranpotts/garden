...
* *link:./stack-language.adoc[Stack language]*: A stack language is one in which the execution model involves pushing operands onto a stack, from which operators consume or produce stack values.
