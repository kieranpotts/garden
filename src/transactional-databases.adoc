...
Also known as *operational databases*, transactional databases are a family of database management systems that are often contrasted with *link:./analytical-databases.adoc[analytical databases]*.
