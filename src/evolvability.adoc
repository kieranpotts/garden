...
*link./distributed-system.adoc[distributed systems]* than it is in
*link:./monolith.adoc[monolithic systems]*. Distributed systems are inherently complex (they have
