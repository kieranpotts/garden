...
An execution model helps in understanding how a computer program will behave when it's code is compiled and executed.
...
Parallel execution models are made possible by *[multi-threaded]* and *link:./distributed-system.adoc[distributed computing]* environments.
