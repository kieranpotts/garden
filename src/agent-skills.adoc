...
NOTE: "Agent skills" in this specification sense is distinct from "tools" in the function-calling sense (tool use, MCP servers). Skills are context bundles — structured documentation the agent reads. Tools are executable programs the agent calls. See link:./model-context-protocol.adoc[Model Context Protocol] for the tool-use protocol.
