...
One of the big advantages of this design pattern is the ease with which data *link:./consistency.adoc[consistency]* can be maintained across the system. And component-to-component interaction is minimized, favoring data sharing through the central store, potentially reducing overall latency in the system.
