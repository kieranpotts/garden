...
and fixes mechanical style violations directly.
...
Mechanical fixes — wrong dash character, hyphen-separated list terms,
wrong-case headings, stray bold — are applied directly. Sentence-level
rewrites and bolding judgment calls are flagged for the user to decide.
