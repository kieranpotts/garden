...
* *link:./src/agent-skills.adoc[Agent skills]* 🌱
...
* *link:./src/code-conventions.adoc[Code conventions]* 🌱
* *link:./src/code-kata.adoc[Code kata]* 🌿
* *link:./src/code-freeze.adoc[Code freeze]* 🌱
* *link:./src/code-reuse.adoc[Code reuse]* 🌱
* *link:./src/cohesion.adoc[Cohesion]* 🌱
* *link:./src/cqrs.adoc[Command Query Responsibility Segregation (CQRS)]* 🌱
* *link:./src/command-query-responsibility-segregation.adoc[Command Query Responsibility Segregation (CQRS)]* 🌱
...
* *link:./src/data-driven-programming.adoc[Data-driven programming]* 🌱
* *link:./src/data-modeling.adoc[Data modeling]* 🌱
* *link:./src/data-oriented-architecture.adoc[Data-oriented architecture]* 🌱
* *link:./src/data-oriented-design.adoc[Data-oriented design]* 🌱
...
* *link:./src/do-what-i-mean.adoc[Do what I mean (DWIM)]* 🌱
...
* *link:./src/egoless-programming.adoc[Egoless programming]* 🌱
...
* *link:./src/formal-methods.adoc[Formal methods]* 🌱
...
* *link:./src/kiss-principle.adoc[KISS principle]* 🌱
...
* *link:./src/law-of-demeter.adoc[Law of Demeter]* 🌱
* *link:./src/laws-and-principles.adoc[Laws and principles]* 🌱
* *link:./src/laws-of-software-evolution.adoc[Laws of software evolution]* 🌱
...
* *link:./src/lean-software-development.adoc[Lean software development]* 🌱
...
* *link:./src/machine-learning.adoc[Machine learning]* 🌱
* *link:./src/makers-schedule.adoc[Maker's schedule]* 🌱
...
* *link:./src/ninety-ninety-rule.adoc[Ninety-ninety rule]* 🌱
...
* *link:./src/open-closed-principle.adoc[Open-closed principle]* 🌱
* *link:./src/osi-model.adoc[OSI model]* 🌱

==== P

* *link:./src/pagination.adoc[Pagination]* 🌱
* *link:./src/pair-programming.adoc[Pair programming]* 🌱
* *link:./src/parallelism.adoc[Parallelism]* 🌿
* *link:./src/pareto-principle.adoc[Pareto principle]* 🌱
* *link:./src/parkinsons-law.adoc[Parkinson's Law]* 🌱
...
* *link:./src/principle-of-least-astonishment.adoc[Principle of least astonishment]* 🌱
...
* *link:./src/quality-assurance.adoc[Quality assurance]* 🌱
...
* *link:./src/release-early-release-often.adoc[Release early, release often]* 🌱
...
* *link:./src/rubber-duck-debugging.adoc[Rubber duck debugging]* 🌱
* *link:./src/rubber-ducking.adoc[Rubber ducking]* 🌱
* *link:./src/rule-of-least-power.adoc[Rule of least power]* 🌱
...
* *link:./src/single-source-of-truth.adoc[Single source of truth]* 🌱
...
* *link:./src/specification-by-example.adoc[Specification by Example]* 🌱
...
* *link:./src/teslers-law.adoc[Tesler's Law]* 🌱
...
* *link:./src/unified-process.adoc[Unified Process]* 🌱
* *link:./src/uniform-access-principle.adoc[Uniform access principle]* 🌱
...
* *link:./src/user-centered-design.adoc[User-centered design]* 🌱
